        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex gap-1">
            <button
              ...
              className={`px-6 py-3 font-semibold text-sm transition-colors relative ${activeTab === 'events'
            ...
            <button
              ...
              className={`px-6 py-3 font-semibold text-sm transition-colors relative ${activeTab === 'analytics'
                  ? 'text-primary border-b-2 border-primary'
                  : 'text-gray-500 hover:text-gray-700'
                }`}
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors whitespace-nowrap ${analyticsPeriod === 1
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors whitespace-nowrap ${analyticsPeriod === 7
                        ? 'bg-beige text-primary-dark shadow-md'
                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors whitespace-nowrap ${analyticsPeriod === 30
                        ? 'bg-beige text-primary-dark shadow-md'
                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors whitespace-nowrap ${analyticsPeriod === 365
                        ? 'bg-beige text-primary-dark shadow-md'
                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                      }`}
                  >
                ...
                <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  <div className="divide-y divide-gray-100">
                    {analytics.event_clicks_by_event.map((item: any) => {
                      ...
                      return (
                        <div key={item.event_id} className={`p-4 flex items-center justify-between hover:bg-gray-50 ${isDeleted ? 'opacity-60' : ''
                          }`}>
                          <div className="flex items-center gap-3">
                            {event?.coverImage ? (
...
const EventModal: React.FC<{ event: EventItem | null, onClose: () => void, onSave: () => void }> = ({ event, onClose, onSave }) => {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      console.log('Setting new cover image path:', result.path);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (event) {
        console.log('Updating event with data:', { ...event, ...formData });
            ...
            {formData.coverImage && (
              <div className="mb-3 relative group">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = 'data:image/svg+xml;base64,';
                  }}
                />
